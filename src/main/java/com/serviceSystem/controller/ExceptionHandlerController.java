...
//    public ResponseEntity handleNpSuchItemException(NoSuchItemException e){
...
//    }
    ...
    @ExceptionHandler(value = {BindingResultException.class,BadCredentialsException.class, NotCorrespondingIdException.class, OrderAlreadyTakenException.class})
